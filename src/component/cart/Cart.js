...
const Cart = () => {
    ...
    return (
        <div className='flex flex-row  fixed right-0 box-border '>
            ...
            <div className={`flex flex-col ${show ? "w-96" : "w-0" } duration-300 h-screen box-border bg-slate-800 `} >
                ...
                <div className='flex flex-col fixed items-center w-96 box-border bottom-0 h-48 border-t-2 bg-slate-800 border-black'>
